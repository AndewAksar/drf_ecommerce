...
class ShippingAddressViewID(APIView):
    ...
    @extend_schema(
        ...
        description='This endpoint a single shipping address associated with a user.',
        tags=tags,
    )
    def get(self, request, *args, **kwargs):
        user = request.user
    ...
    @extend_schema(
        ...
        description='This endpoint allows a user to update a shipping address.',
        tags=tags,
    )
    ...
    @extend_schema(
        ...
        description='This endpoint allows a user to delete a shipping address.',
        tags=tags,
    )
